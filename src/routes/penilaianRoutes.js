...
router.post("/", authenticate, authorizeRole(["juri"]), createPenilaian);
...
router.delete("/undo/:pertandingan_id", authenticate, authorizeRole(["juri"]), undoPenilaian);
router.delete("/:pertandingan_id/reset", authenticate, authorizeRole(["admin"]), resetPenilaian);
